        ...
        public static async Task<List<ModeleBasePTV>> TraitFluxSmartour(List<FluxPtv> FluxptvList)
        {
            ...
            for (int i = 0; i < ListModeleBasePTV.Count; i++)
            {
                ...
                if (FluxptvList[i].Agence.CodeNumerique.Length==2)
                {
                    ...
                    if (FluxptvList[i].Agence.CodeNumerique.Substring(0, 2)== "35" || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "33"|| FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "76" || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "67"
                        || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "21" || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "41"
                        || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "63" || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "79"
                        || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "14" || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "29"
                        || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "31" || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "26"
                        || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "54" || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "34"
                        || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "69" || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "62"
                        || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "96" || FluxptvList[i].Agence.CodeNumerique.Substring(0, 2) == "83")
                    {
...

                {
                  ...
                  {
                    Depot = string.Concat("DEPOT", FluxptvList[i].Agence.CodeNumerique, "_MRAOD");
                }
